  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(title: "Manage", subTitle: "Inventory"),
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: const [
              SubScreenNavigatorWidget(label: "ADD ITEM", route: '/manageInventoryScreen'),
    ...
    return Column(
      ...
      children: [
        ...
        TextField(
          ...
          onChanged: (item) {
            BlocProvider.of<InventoryHomeCubit>(context).searchProduct(item);
          },
        ),
      ],
    );
            ...
            child: ListView.builder(
              ...
              itemBuilder: (_, index) {
                return ProductCardWidget(
                  ...
                  index: index,
                  isItemInStock: BlocProvider.of<InventoryHomeCubit>(context).getStockStatus(index),
                );
              },
            ),
          );
