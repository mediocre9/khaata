        ...
        children: [
          ListTile(
            ...
            leading: TextButton.icon(
              ...
              onPressed: () => Navigator.pushNamedAndRemoveUntil(context, '/UserScreen', (route) => false),
            ),
          ),
        ],
      ),
            ...
            child: ListTile(
              ...
              onTap: () {
                switch (drawerItems[index].toUpperCase()) {
                  case 'INVENTORY':
                    Navigator.pushNamedAndRemoveUntil(context, '/InventoryScreen', (route) => false);
                    break;
                  ...
                  case 'FINANCE':
                    Navigator.pushNamedAndRemoveUntil(context, '/FinanceScreen', (route) => false);
                    break;
                ...
                onTap: () {
                  switch (subItems[index].toUpperCase()) {
                    case 'MANAGE':
                      ...
                      break;
                    case 'PENDING':
                      Navigator.pushNamedAndRemoveUntil(context, '/PendingScreen', (route) => false);
                      break;
